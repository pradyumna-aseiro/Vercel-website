...
export const productSections = [
    ...
    items: [
      {
        ...
        description:
          "An area scan camera captures a full 2D image in a single exposure using a grid of pixel sensors.",
  ...
  // Other product sections can go here (like "Smart Cameras", "3D Cameras", etc.)
];
